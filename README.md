...
从 [Releases v2.2.1](https://github.com/zhangyinglong3550/switchyard/releases/tag/v2.2.1) 下载：

| 平台 | 文件 |
|------|------|
| macOS (Apple Silicon) | `Switchyard-2.2.1-arm64.dmg` |
| macOS (Intel / x64) | `Switchyard-2.2.1.dmg` |
| Windows (x64) | `Switchyard Setup 2.2.1.exe` 或 `Switchyard-2.2.1-win.zip` |
