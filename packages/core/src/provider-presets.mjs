...
export const PROVIDER_PRESETS = [
  ...
  },
  {
    ...
    models: [
      ...
      { id: "claude-opus-4-6-thinking", displayName: "Claude Opus 4.6 Thinking", contextWindow: 1000000, capabilities: { reasoning: true, tools: true, stream: true, multimodal: true, images: true } },
      { id: "gpt-oss-120b-medium", displayName: "GPT-OSS 120B Medium", contextWindow: 131072, capabilities: { tools: true, stream: true } }
    ]
  },
  {
  ...
  },
  {
    ...
    experimental: true,
    riskLevel: "high",
    riskNote: "Sub2API 备份内含订阅账号凭证。仅导入你有权使用的账号；凭证只保存在本机 Switchyard 账号池。",
    note: "直接导入 sub2api-data JSON 到 Switchyard，原生调用 Codex；不需要 Sub2API 服务、API 地址或管理密钥。",
    models: [
